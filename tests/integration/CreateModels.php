...
trait CreateModels
{
    ...
    {
        return Factory::create('Difftechnology\Notifynder\Models\NotificationCategory', $data);
    }
    ...
    {
        return Factory::create('Difftechnology\Notifynder\Models\NotificationGroup', $data);
    }
    ...
    {
        return Factory::create('Difftechnology\Tests\Models\User', $data);
    }
}
